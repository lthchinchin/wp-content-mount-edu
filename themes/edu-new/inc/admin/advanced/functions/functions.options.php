...
if (!function_exists('of_options')) {
	...
	function of_options()
	{
		...
		$of_options[] = array(
			...
			'desc' => 'Add footer background here',
			'id'   => 'html_footer_background',
			'std'  => '',
			'type' => 'upload',
		);
		$of_options[] = array(
			'name' => 'BCT logo',
			'desc' => 'Add bct logo here',
			'id'   => 'html_bct_logo',
			'std'  => '',
			'type' => 'upload',
		);
		...
		$of_options[] = array(
			'name' => 'Use learnpress default style single-course',
			'id'   => 'active_lp_single-course',
			'desc' => 'Enable active Learnpress Single course',
			'std'  => 0,
			'type' => 'checkbox',
		);
